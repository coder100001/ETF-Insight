...
import { Card, Row, Col, Select, Button, DatePicker, InputNumber, Table, Tag, Spin, Alert, Statistic, Timeline, Tabs } from 'antd';
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, AreaChart, Area, BarChart, Bar } from 'recharts';
import { HistoryOutlined, PlayCircleOutlined, DollarOutlined, RiseOutlined, FallOutlined } from '@ant-design/icons';
