...
import {
  ...
  Tabs, Button, Tooltip, Alert, Divider
} from 'antd';
import {
    ...
    },
    {
      ...
      render: (value: number, record: AShareHoldingDetail) => (
        editing ? (
          <EditableCell>
            <InputNumber
              value={investments[record.symbol] || value}
              onChange={(v) => handleInvestmentChange(record.symbol, v)}
              ...
              <BarChart data={barData}>
                ...
                <RechartsTooltip
                  formatter={(value: number, name: string) => {
                    if (name === '投资金额') {
                      return [formatMoney(value * 10), name];
                    }
