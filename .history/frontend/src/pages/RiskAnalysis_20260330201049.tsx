...
const RiskAnalysis = () => {
  ...
  const columns = [
    { title: 'ETF', dataIndex: 'symbol', key: 'symbol', fixed: 'left' as const },
    {
      ...
      sorter: (a: TableData, b: TableData) => a.volatility - b.volatility,
    },
    {
      title: '夏普比率',
      ...
      sorter: (a: TableData, b: TableData) => a.sharpe_ratio - b.sharpe_ratio,
    },
    {
      title: '索提诺比率',
      ...
      key: 'sortino_ratio',
      render: (v: number) => v?.toFixed(2),
      sorter: (a: TableData, b: TableData) => a.sortino_ratio - b.sortino_ratio,
    },
    {
      title: '最大回撤',
      ...
      sorter: (a: TableData, b: TableData) => a.max_drawdown - b.max_drawdown,
    },
    {
      title: '回撤天数',
