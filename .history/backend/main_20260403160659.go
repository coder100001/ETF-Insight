...
func main() {
	...
	router.GET("/api/exchange-rates/sync/status", exchangeRateHandler.GetSyncStatus)
	router.GET("/api/exchange-rates/sync/logs", exchangeRateHandler.GetSyncLogs)
	router.GET("/api/exchange-rates/sync/logs/:id", exchangeRateHandler.GetSyncLogDetails)
	router.GET("/api/currency-pairs", exchangeRateHandler.GetCurrencyPairs)
	router.POST("/api/currency-pairs", exchangeRateHandler.CreateCurrencyPair)
	router.PUT("/api/currency-pairs/:id", exchangeRateHandler.UpdateCurrencyPair)
	router.DELETE("/api/currency-pairs/:id", exchangeRateHandler.DeleteCurrencyPair)
