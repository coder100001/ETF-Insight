...
// Create 创建记录
func (db *MockDB) Create(value interface{}) error {
	db.mu.Lock()
	defer db.mu.Unlock()
...
// First 获取第一条记录
func (db *MockDB) First(dest interface{}, conds ...interface{}) error {
	return nil
}

// Find 查询多条记录
func (db *MockDB) Find(dest interface{}, conds ...interface{}) error {
	return nil
}
...
// Updates 更新记录
func (db *MockDB) Updates(values interface{}) error {
	return nil
}

// Save 保存记录
func (db *MockDB) Save(value interface{}) error {
	return nil
}
