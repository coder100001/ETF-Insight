	...
	return []models.ETFConfig{
		{
			...
			Description:     "美国股息股票ETF，追踪道琼斯美国股息100指数",
			Strategy:        "股息价值",
			Focus:           "高股息",
			Status:          1,
			AutoUpdate:      true,
		...
		},
		{
			...
			Description:     "纳斯达克股票覆盖收益ETF，提供高股息收益",
			Strategy:        "覆盖收益",
			Focus:           "高股息",
			Status:          1,
			AutoUpdate:      true,
		...
		},
		{
			...
			Description:     "标普股票覆盖收益ETF，平衡收益与增长",
			Strategy:        "覆盖收益",
			Focus:           "高股息",
			Status:          1,
			AutoUpdate:      true,
		...
		},
		{
			...
			Description:     "标普500高股息ETF，投资高股息率大盘股",
			Strategy:        "股息价值",
			Focus:           "高股息",
			Status:          1,
			AutoUpdate:      true,
